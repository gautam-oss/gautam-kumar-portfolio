...
const projects = [
  {
    ...
    description: "Microservices-based healthcare platform for patient records and appointment scheduling, with an AI-powered clinical document search feature enabling natural-language queries over unstructured medical notes via a LangChain RAG pipeline.",
    tags: ["Java", "Spring Boot", "PostgreSQL", "Redis", "Apache Kafka", "LangChain", "Vector Search", "Docker", "Kubernetes", "Jenkins", "Grafana"],
    github: "https://github.com/gautamkumar-oss-hub/merchant-checkout-platform/",
    highlights: ["Independent Spring Boot services over REST + Kafka", "Redis caching on high-read lookups", "Jenkins CI/CD + Grafana dashboards"],
    accent: "var(--accent)",
  },
  {
    num: "02",
    title: "Merchant Checkout Platform",
    subtitle: "Personal Project",
    description: "E-commerce checkout and order-processing service handling cart-to-order conversion, decoupling fast checkout responses from slower downstream order processing with idempotency-key handling to prevent duplicate orders under client retries.",
    tags: ["Java", "Spring Boot", "PostgreSQL", "Redis", "RabbitMQ", "Docker", "Kubernetes", "Jenkins", "Grafana"],
    github: "https://github.com/gautamkumar-oss-hub/merchant-checkout-platform/",
    highlights: ["Redis-backed cart sessions", "RabbitMQ async inventory events", "Grafana order & queue metrics"],
    accent: "var(--accent-2)",
  },
];
