...
const projects = [
  {
    num: "01",
    title: "Cloud-Native Telemedicine Consultation Platform",
    subtitle: "Personal Project · Spring 2026",
    description: "Scalable microservices-based healthcare platform supporting patient records and appointment scheduling, with an AI-powered clinical document search feature for natural-language queries over unstructured medical notes.",
    tags: ["Java", "Spring Boot", "REST", "GraphQL", "PostgreSQL", "Redis", "Apache Kafka", "LangChain", "RAG", "Docker", "Kubernetes", "AWS"],
    github: "https://github.com/gautamkumar-oss-hub",
    highlights: ["5 Spring Boot microservices over REST + GraphQL", "~150 requests/sec in local load testing", "AWS EKS deployment with Jenkins CI/CD"],
    accent: "var(--accent)",
  },
  {
    num: "02",
    title: "Private Search Engine",
    subtitle: "Personal Project · Summer 2026",
    description: "Privacy-focused web search engine built with Python and FastAPI, implementing web crawling, document parsing, indexing, full-text search, and relevance-based ranking without user tracking or search-history profiling.",
    tags: ["Python", "FastAPI", "Meilisearch", "PostgreSQL", "Redis", "Docker", "Semantic Search"],
    github: "https://github.com/gautamkumar-oss-hub",
    highlights: ["Keyword and semantic/hybrid retrieval", "Redis caching for search performance", "Containerized privacy-first architecture"],
    accent: "var(--accent-2)",
  },
];
